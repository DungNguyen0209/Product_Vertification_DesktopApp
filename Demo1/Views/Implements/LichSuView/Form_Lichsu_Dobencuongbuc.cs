...
{
    public partial class Form_Lichsu_Dobencuongbuc : UserControl
    {
        public Form_Lichsu_Dobencuongbuc()
        {
            InitializeComponent();
        }

        private void Form_Lichsu_Dobencuongbuc_Load(object sender, EventArgs e)
        {
